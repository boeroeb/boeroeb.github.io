...
!function(c){c.fn.simpleJekyllSearch=function(e){var s=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} </a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),o=s.jsonFormat.split(","),a=[],l=this,i=c(s.searchResults);function r(){i.children().remove()}s.jsonFile.length&&i.length&&c.ajax({type:"GET",url:s.jsonFile,dataType:"json",success:function(e,n,t){a=e,l.keyup(function(e){var n,t,l;c(this).val().length?(t=c(this).val(),l=[],c.each(a,function(e,n){for(e=0;e<o.length;e++)void 0!==n[o[e]]&&-1!==n[o[e]].toLowerCase().indexOf(t.toLowerCase())&&(l.push(n),e=o.length)}),n=l,r(),i.append(c(s.searchResultsTitle)),n.length?c.each(n,function(e,n){if(e<s.limit){for(var t=s.template,e=0;e<o.length;e++){var l=new RegExp("{"+o[e]+"}","g");t=t.replace(l,n[o[e]])}i.append(c(t))}}):i.append(s.noResults)):r()})},error:function(e,n,t){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(n),console.log(t)}})}}(Zepto);
